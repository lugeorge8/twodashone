      ...
      <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col justify-between px-5 py-12">
        <header className="flex flex-col gap-4">
          ...
          <h1 className="text-3xl font-semibold leading-tight tracking-tight">
            Practice augment decisions.
          </h1>
          <p className="max-w-xl text-base leading-7 text-zinc-600 dark:text-zinc-400">
            Curated training sets scored against pro answers.
          </p>
        </header>
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <div className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                  Generates 3 choices with a one-time reroll per slot
                </div>
              </div>
              <Link
                href="/train/random"
        ...
        <footer className="mt-10 text-xs leading-5 text-zinc-500 dark:text-zinc-400">
          Built for reps. Not a solver. Best pick = the referenced pro’s answer for the spot.
        </footer>
      </main>
    </div>
  );
